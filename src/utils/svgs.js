...
export const Mic = (props) => (
  ...
  d="M41 32a10 10 0 0 1-10 10 10 10 0 0 1-10-10V12A10 10 0 0 1 31 2a10 10 0 0 1 10 10z"
   stroke="white" strokeMiterlimit="10" strokeWidth="2"></path>
  <path data-name="layer1" d="M49 22v10a18 18 0 0 1-18 18 18 18 0 0 1-18-18V22m18 28v12m-10 0h20"
  fill="none" stroke="white" strokeMiterlimit="10" strokeWidth="5"></path>
  </svg>
);
...
export const MutedMic = (props) => (
  ...
  >
    ...
    <path data-name="layer2"
      d="M41 32a10 10 0 0 1-10 10 10 10 0 0 1-10-10V12A10 10 0 0 1 31 2a10 10 0 0 1 10 10z"
      stroke="red" strokeMiterlimit="10" strokeWidth="2"></path>
    <path data-name="layer1" d="M49 22v10a18 18 0 0 1-18 18 18 18 0 0 1-18-18V22m18 28v12m-10 0h20"
      fill="none" stroke="red" strokeMiterlimit="10" strokeWidth="5"></path>
      <svg
    role="img"
...
export const Chat = (props) => (
  ...
  >
    ...
    <path stroke="white" strokeWidth="1" d="M12,26.449c-2.206,0-4,1.794-4,4s1.794,4,4,4s4-1.794,4-4S14.206,26.449,12,26.449z M12,32.449c-1.103,0-2-0.897-2-2   s0.897-2,2-2s2,0.897,2,2S13.103,32.449,12,32.449z"/>
    <path stroke="white" strokeWidth="1" d="M23,26.449c-2.206,0-4,1.794-4,4s1.794,4,4,4s4-1.794,4-4S25.206,26.449,23,26.449z M23,32.449c-1.103,0-2-0.897-2-2   s0.897-2,2-2s2,0.897,2,2S24.103,32.449,23,32.449z"/>
    <path stroke="white" strokeWidth="1" d="M34,26.449c-2.206,0-4,1.794-4,4s1.794,4,4,4s4-1.794,4-4S36.206,26.449,34,26.449z M34,32.449c-1.103,0-2-0.897-2-2   s0.897-2,2-2s2,0.897,2,2S35.103,32.449,34,32.449z"/>
  </svg>
);
...
export const Reactions = (props) => (
  ...
  >
    <title>{props.title}</title>
    <path d="M8.4,0a8.4,8.4,0,0,0,0,16.8h0a8.4,8.4,0,0,0,8.4-8.4" transform="translate(2.4 4.8)" fill="white" stroke="white" strokeMiterlimit="10" strokeWidth="1.5"/>
    <path d="M0,0A4.807,4.807,0,0,0,1.042,1.557,4.785,4.785,0,0,0,4.436,2.963h0A4.785,4.785,0,0,0,7.83,1.557,4.807,4.807,0,0,0,8.872,0" transform="translate(6.364 15.037)" fill="white" stroke="black" strokeMiterlimit="10" strokeWidth="1.5"/>
    <circle data-name="Oval" cx="1.2" cy="1.2" r="1.2" transform="translate(7.2 9.6)" fill="black" stroke="black" strokeWidth="1"/>
    <circle data-name="Oval" cx="1.2" cy="1.2" r="1.2" transform="translate(12 9.6)" fill="black" stroke="black" strokeWidth="1"/>
    <path d="M1.2,0V7.2" transform="translate(18 1.2)" fill="white" stroke="white" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="1.5"/>
    <path d="M0,1.2H7.2" transform="translate(15.6 3.6)" fill="white" stroke="white" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="1.5"/>
  </svg>
);