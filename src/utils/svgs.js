...
export const Mic = (props) => (
  ...
  fill="none" stroke="white" stroke-miterlimit="10" stroke-width="5"></path>
  </svg>
);
...
export const MutedMic = (props) => (
  ...
  >
    ...
    <path data-name="layer2"
      d="M41 32a10 10 0 0 1-10 10 10 10 0 0 1-10-10V12A10 10 0 0 1 31 2a10 10 0 0 1 10 10z"
      stroke="red" stroke-miterlimit="10" stroke-width="2"></path>
    <path data-name="layer1" d="M49 22v10a18 18 0 0 1-18 18 18 18 0 0 1-18-18V22m18 28v12m-10 0h20"
      fill="none" stroke="red" stroke-miterlimit="10" stroke-width="5"></path>
      <svg
    role="img"
  ...
  >
      <title>{props.title}</title>
      <path transform="rotate(15)" d="M335.307,0.664c-12.909-3.079-25.742,4.848-28.831,17.681L188.245,511.77c-3.07,12.843,4.848,25.742,17.681,28.831   c1.875,0.449,3.758,0.66,5.594,0.66c10.806,0,20.598-7.373,23.237-18.341l118.23-493.425   C356.058,16.652,348.14,3.753,335.307,0.664z" />
    </svg>
  </svg>
);
...
export const Reactions = (props) => (
  ...
  >
    <title>{props.title}</title>
    <path d="M8.4,0a8.4,8.4,0,0,0,0,16.8h0a8.4,8.4,0,0,0,8.4-8.4" transform="translate(2.4 4.8)" fill="white" stroke="white" stroke-miterlimit="10" stroke-width="1.5"/>
    <path d="M0,0A4.807,4.807,0,0,0,1.042,1.557,4.785,4.785,0,0,0,4.436,2.963h0A4.785,4.785,0,0,0,7.83,1.557,4.807,4.807,0,0,0,8.872,0" transform="translate(6.364 15.037)" fill="white" stroke="black" stroke-miterlimit="10" stroke-width="1.5"/>
    <circle data-name="Oval" cx="1.2" cy="1.2" r="1.2" transform="translate(7.2 9.6)" fill="black" stroke="black" stroke-width="1"/>
    <circle data-name="Oval" cx="1.2" cy="1.2" r="1.2" transform="translate(12 9.6)" fill="black" stroke="black" stroke-width="1"/>
    <path d="M1.2,0V7.2" transform="translate(18 1.2)" fill="white" stroke="white" stroke-linecap="square" stroke-miterlimit="10" stroke-width="1.5"/>
    <path d="M0,1.2H7.2" transform="translate(15.6 3.6)" fill="white" stroke="white" stroke-linecap="square" stroke-miterlimit="10" stroke-width="1.5"/>
  </svg>
);