...
export default function Info() {
    const rowsGenaral = [
        {
            ...
            answer: <div className="flex flex-row items-center gap-10 text-xl">
                <div>
                    <p> We can recognize 4 hand gestures: </p>
                </div>
                <div className="flex flex-row items-center text-xl gap-2">
                    <p>Like: </p><img src={likeIcon} style={{ height: 30 }} />
                    <p>Dislike: </p><img src={dislikeIcon} style={{ height: 30 }} />
                    <p>Raise Hand: </p><img src={raiseHandIcon} style={{ height: 38 }} />
                    <p>Fist: </p><img src={fistIcon} style={{ height: 40 }} />
                </div>
            </div>
        ...
        },
        {
            ...
            answer: <div className="flex flex-row items-center text-xl">
        ...
        },
        {
            ...
            answer: <div className="flex flex-row gap-4 items-center text-xl">
    ...
    const rowsManager = [
        ...
        {
            question: "What is Homeroom statistics tab ?",
            answer: <div className="flex flex-row gap-4 items-center text-xl">
